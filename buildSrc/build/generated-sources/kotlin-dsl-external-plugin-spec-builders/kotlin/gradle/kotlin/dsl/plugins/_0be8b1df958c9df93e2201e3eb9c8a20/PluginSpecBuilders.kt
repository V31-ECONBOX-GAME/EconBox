...
package gradle.kotlin.dsl.plugins._0be8b1df958c9df93e2201e3eb9c8a20
...
/**
 * The `io.github.fourlastor` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoGithubFourlastorPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.github.fourlastor`.
 */
internal
val `IoGithubPluginGroup`.`fourlastor`: `IoGithubFourlastorPluginGroup`
    get() = `IoGithubFourlastorPluginGroup`(plugins)


/**
 * The `io.github.fourlastor.construo` plugin implemented by [io.github.fourlastor.construo.ConstruoPlugin].
 */
internal
val `IoGithubFourlastorPluginGroup`.`construo`: PluginDependencySpec
    get() = plugins.id("io.github.fourlastor.construo")
